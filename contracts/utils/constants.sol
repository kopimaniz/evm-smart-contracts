...
contract Constant {
    string constant public ROCK_BREEDING_FEE = "ROCK_BREEDING_FEE";
    string constant public ROCK_RENTING_FEE = "ROCK_RENTING_FEE";
    string constant public ROCK_TIME_COST_UNIT = "ROCK_TIME_COST_UNIT";
